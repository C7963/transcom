 ...
 *
 * This file represents a series of Skyworks Si5386A Rev E 
 ...
 * Timestamp:                                          2025-01-10 11:04:38 GMT+08:00
 *
...
#define SI5386A_1D2288G_REG_CONFIG_NUM_IN100M_OUT100M				574


si5386a_reve_register_t const si5386a_reve_registers_cfg2[SI5386A_1D2288G_REG_CONFIG_NUM_IN100M_OUT100M] =
{
 ...
 * 
 * Part:               Si5386A Rev E
 * Project File:       C:\Users\Worker\Documents\WeChat Files\wxid_pf7q4pcwh2s822\FileStorage\File\2025-01\A702_Si5386A_cfg1.slabtimeproj
 * Design ID:          0000FFFF
 * Created By:         ClockBuilder Pro v4.12.0.3 [2024-03-06]
 * Timestamp:          2025-01-10 11:04:38 GMT+08:00
 * 
 ...
 * 
 * Warnings:
 * - Because DCLK OUT0 and SYSREF OUT0A are on the same MultiSynth (N3), you will
 *   not be able to independently adjust the skew via the 'Output Skew Control'
 *   page. [1]
 * - Because DCLK OUT3 and SYSREF OUT2 are on the same MultiSynth (N2), you will
 *   not be able to independently adjust the skew via the 'Output Skew Control'
 *   page. [1]
 * 
 * Footnotes:
 * [1] You can resolve this issue by manually assigning your SYSREFs to a MultiSynth (Nx divider) using the N Divider drop down in CBPro.
 * 
 * Design
 * ======
 * Host Interface:
 ...
 *          Relative Static O/O Skew: 0 ps 
 * 
 *    N1_DELAY:                   0xC700 -57d (Twos compliment div 256)
 ...
 *          Relative Static O/O Skew: 0 ps 
 * 
 *    N2_DELAY:                   0x8100 -127d (Twos compliment div 256)
 *    N2_IODELAY_STEP:               0x1 1d
 *    N2_IODELAY_COUNT:           0x2E42 11842d
 *    N2_IODELAY_INC:                0x0
 *    N2_IODELAY_DEC:                0x1
 * 
 *    Desired Dynamic Skew Step:  °¿0.000 ps
 ...
 *          Relative Static O/O Skew: 0 ps 
 * 
 *    N3_DELAY:                   0x8100 -127d (Twos compliment div 256)
 *    N3_IODELAY_STEP:               0x1 1d
 *    N3_IODELAY_COUNT:           0x2E47 11847d
 *    N3_IODELAY_INC:                0x0
 *    N3_IODELAY_DEC:                0x1
 * 
 *    Desired Dynamic Skew Step:  °¿0.000 ps
 ...
 * VDD:      1.8 V
 * Ta:       25 °„C
 * Theta-JA: 22.00 °„C/W (JEDEC Board with 0 m/s airflow)
 * 
 *                                  Overall  On Chip
 * Condition                        Power    Power    Ta    Tj
 * -------------------------------  -------  -------  ----  -----
 * Typical Ta, Voltage, Current     961 mW   921 mW   25 C  45 C
 * Worst-Case Ta, Voltage, Current  1.296 W  1.255 W  85 C  112 C
 * 
 *                                    -----------------------  -----------------------
 *                                            Typical                Worst-Case       
 *                                    -----------------------  -----------------------
 ...
 *        ------  ----------  ------  -------  -------  -----  -------  -------  -----  -------
 * VDD                                   1.80      196    353     1.89      330    623    68.0%
 * VDDA                                  3.30      127    419     3.47      135    467     6.2%
 * VDDO0  OUT0A      1.2 MHz    LVDS     1.80       32     58     1.89       34     63     4.3%
 *        OUT0     307.2 MHz    LVDS     4.3%
 * VDDO1  OUT1        Unused        
 * VDDO2  OUT2       1.2 MHz    LVDS     1.80       15     28     1.89       16     30     4.6%
 * VDDO3  OUT3     307.2 MHz    LVDS     1.80       17     30     1.89       17     33     4.0%
 * VDDO4  OUT4        Unused        
 * VDDO5  OUT5        Unused        
 * VDDO6  OUT6    122.88 MHz    LVDS     1.80       16     29     1.89       17     31     4.4%
 * VDDO7  OUT7        Unused        
 * VDDO8  OUT8        Unused        
 * VDDO9  OUT9        Unused             1.80       25     44     1.89       25     48     2.6%
 *        OUT9A   1.2288 GHz    LVDS     2.6%
 *                                    -------  -------  -----  -------  -------  -----  -------
 *                                       1.80      301    542     1.89      439    829    45.6%
 *                                       3.30      127    419     3.47      135    467     6.2%
 *                                    -------  -------  -----  -------  -------  -----  -------
 *                                      Total             961    Total           1,296
 *                                    -------  -------  -----  -------  -------  -----  -------
 * 
 * Note:
 * 
 * - Tj is junction temperature. Tj must be less than 125 °„C (on Si5386 Revision
 ...
 * 0x0106[2:0]   OUT0A_MUX_SEL               3                  0x3              
 ...
 * 0x0247[23:0]  R0A_REG                     255                0x0000FF         
 * 0x024A[23:0]  R0_REG                      0                  0x000000         
 * 0x024D[23:0]  R1_REG                      0                  0x000000         
 * 0x0250[23:0]  R2_REG                      255                0x0000FF         
 ...
 * 0x0271[7:0]   DESIGN_ID6                  70                 0x46             
 * 0x0272[7:0]   DESIGN_ID7                  70                 0x46             
 ...
 * 0x035B[15:0]  N1_DELAY                    50944              0xC700           
 * 0x035D[15:0]  N2_DELAY                    33024              0x8100           
 * 0x035F[15:0]  N3_DELAY                    33024              0x8100           
 ...
 * 0x0515[55:0]  M_NUM                       4947802324992      0x00048000000000 
 ...
 * 0x0522[0]     M_FSTEP_MSK                 1                  0x1              
 * 0x0522[1]     M_FSTEPW_DEN                0                  0x0              
 * 0x0523[55:0]  M_FSTEPW                    0                  0x00000000000000 
 ...
 * 0x058B[19:0]  HSW_MEAS_SETTLE             22130              0x05672          
 ...
 * 0x0A14[3]     N0_LOAD_AUTO_DIS            1                  0x1              
 ...
 * 0x0A54[7:0]   N2_IODELAY_STEP             1                  0x01             
 * 0x0A55[15:0]  N2_IODELAY_COUNT            11842              0x2E42           
 * 0x0A57[0]     N2_IODELAY_INC              0                  0x0              
 * 0x0A57[1]     N2_IODELAY_DEC              1                  0x1              
 * 0x0A58[7:0]   N3_IODELAY_STEP             1                  0x01             
 * 0x0A59[15:0]  N3_IODELAY_COUNT            11847              0x2E47           
 * 0x0A5B[0]     N3_IODELAY_INC              0                  0x0              
 * 0x0A5B[1]     N3_IODELAY_DEC              1                  0x1              
...
#define SI5386A_1D2288G_REG_CONFIG_NUM_IN100M_OUT10M	574
si5386a_reve_register_t const si5386a_reve_registers_cfg4[SI5386A_1D2288G_REG_CONFIG_NUM_IN100M_OUT10M] =
{
	/* Start configuration preamble */
	{ 0x0B24, 0xC0 },
	{ 0x0B25, 0x00 },
